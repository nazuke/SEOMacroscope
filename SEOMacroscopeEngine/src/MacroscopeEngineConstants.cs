...
namespace SEOMacroscopeEngine
{
  ...
  /// <summary>
  /// Description of MacroscopeEngineConstants.
  /// </summary>

  public static class MacroscopeEngineConstants
  {
    ...
    public static Dictionary<MacroscopeEngineConstants.Contains,string> ContainsLabels = new Dictionary<MacroscopeEngineConstants.Contains,string> () {
      {
        MacroscopeEngineConstants.Contains.UNDEFINED,
        "UNDEFINED"
      },
      {
        MacroscopeEngineConstants.Contains.MUSTHAVE,
        "MUST HAVE STRING"
      },
      {
        MacroscopeEngineConstants.Contains.MUSTNOTHAVE,
    ...
    public static Dictionary<MacroscopeEngineConstants.TextPresence,string> TextPresenceLabels = new Dictionary<MacroscopeEngineConstants.TextPresence,string> () {
      {
        MacroscopeEngineConstants.TextPresence.UNDEFINED,
        @"UNDEFINED"
      },
      {
        MacroscopeEngineConstants.TextPresence.CONTAINS,
        @"CONTAINS STRING"
      },
      {
        MacroscopeEngineConstants.TextPresence.MUSTCONTAIN,
        @"MUST CONTAIN STRING"
      },
      {
        MacroscopeEngineConstants.TextPresence.NOTCONTAINS,
        @"DOES NOT CONTAIN STRING"
      },
      {
        MacroscopeEngineConstants.TextPresence.SHOULDNOTCONTAIN,
