...
namespace SEOMacroscope
{
  ...
  [TestFixture]
  public class TestMacroscopeCsvCustomFilterReport : Macroscope
  {
    ...
    public void TestWriteCsv ()
    {
      ...
      MacroscopeCsvCustomFilterReport ReportFile = new MacroscopeCsvCustomFilterReport( NewCustomFilter: CustomFilter );
