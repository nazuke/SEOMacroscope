...
namespace SEOMacroscope
{
  ...
  [TestFixture]
  public class TestMacroscopeExcelExportListViewReport : Macroscope
  {

    /**************************************************************************/

    // TODO: Implemenent mock ListView:
    ...
    public void TestWriteXslx ()
    {
      ...
      MacroscopeExcelExportListViewReport Report = new MacroscopeExcelExportListViewReport();
