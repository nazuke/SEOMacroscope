...
namespace SEOMacroscope
{
  ...
  public partial class MacroscopeMainForm : Form, IMacroscopeTaskController
  {
    ...
    public void SetStructureOverviewControlsToScanning ()
    {
      ...
      this.DisableTabPage( TabName: MacroscopeConstants.tabPageRedirectChains );
      ...
      this.DisableTabPage( TabName: MacroscopeConstants.tabPagePageKeywordsPresence );
    ...
    public void SetStructureOverviewControlsToEnabled ()
    {
      ...
      this.EnableTabPage( TabName: MacroscopeConstants.tabPageRedirectChains );
      ...
      this.EnableTabPage( TabName: MacroscopeConstants.tabPagePageKeywordsPresence );
