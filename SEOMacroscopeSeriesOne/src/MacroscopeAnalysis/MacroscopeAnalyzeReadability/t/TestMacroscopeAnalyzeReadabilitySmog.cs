...
{
  [TestFixture]
  public class TestMacroscopeAnalyzeReadabilitySmog : Macroscope
  {

    /**************************************************************************/

    [Test]
    public void Test01SubtractSilentVowel ()
    {
    ...
    [Test]
    public void Test04CountSyllables ()
    {
    ...
    [Test]
    public void Test10AnalyzeSmogGrade ()
    {
      ...
      foreach( string SampleText in SampleTexts )
      {
        ...
        Assert.GreaterOrEqual( SmogGrade, 1, "Unexpected SmogGrade" );

        Assert.LessOrEqual( SmogGrade, 21, "Unexpected SmogGrade" );
    ...
    public void Test11GradeToString ()
    {
      ...
      foreach( string SampleText in SampleTexts )
      {
        ...
        ms.DebugMsg( string.Format( "Graded: {0} => \"{1}\"", SmogGrade, GradeString ) );
