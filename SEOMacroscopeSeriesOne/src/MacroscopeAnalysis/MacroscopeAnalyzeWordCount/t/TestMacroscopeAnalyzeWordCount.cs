...
namespace SEOMacroscope
{
  ...
  [TestFixture]
  public class TestMacroscopeAnalyzeWordCount : Macroscope
  {

    /**************************************************************************/

    [Test]
    public void TestCountTenWords ()
    {
      string Text = "Lorem ipsum dolor sit amet, consectetur adipiscing elit. Cras commodo.";
      Assert.AreEqual( 10, MacroscopeAnalyzeWordCount.CountWords( Text: Text ) );
    }

    /**************************************************************************/

    [Test]
    public void TestCountManyWords ()
    {
      ...
      Assert.AreEqual( 506, MacroscopeAnalyzeWordCount.CountWords( Text: Text ) );
    }
    ...
    {
      string Text = "                          ";
      Assert.AreEqual( 0, MacroscopeAnalyzeWordCount.CountWords( Text: Text ) );
    }
    ...
    /*
    [Test]
    public void TestCountPunctuationWords ()
    {
      string Text = " ,.;'[]{}!@#$%^&*()_+";
      Assert.AreEqual( 0, MacroscopeAnalyzeWordCount.CountWords( Text: Text ) );
    }
