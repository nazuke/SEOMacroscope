...
namespace SEOMacroscope
{
  ...
  [TestFixture]
  public class TestMacroscopeAnalyzePageBodyText
  {
    ...
    public void TestCorrectAnalyzeLanguage ()
    {
      ...
      MacroscopeAnalyzePageBodyText AnalyzePageBodyText = new MacroscopeAnalyzePageBodyText ();

      foreach( string TextSample in Texts.Keys )
      {

        string ProbableLanguage = AnalyzePageBodyText.AnalyzeLanguage( Text: TextSample );
