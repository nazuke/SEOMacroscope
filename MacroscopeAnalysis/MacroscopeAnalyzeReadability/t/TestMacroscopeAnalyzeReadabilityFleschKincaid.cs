  ...
  public class TestMacroscopeAnalyzeReadabilityFleschKincaid
  {
    ...
    public void Test01CountWords ()
    {
      ...
      foreach( string SampleText in SampleTexts )
      {
        ...
        //Assert.LessOrEqual( WordCount, 100, "Unexpected WordCount" );
    ...
    public void Test02CountSyllables ()
    {
      ...
      foreach( string SampleText in SampleTexts )
      {
        ...
        //Assert.LessOrEqual( SyllableCount, 100, "Unexpected SyllableCount" );
    ...
    public void Test03CountSentences ()
    {
      ...
      foreach( string SampleText in SampleTexts )
      {
        ...
        //Assert.LessOrEqual( SentenceCount, 21, "Unexpected SentenceCount" );
    ...
    /*
    [Test]
    public void TestSubtractSilentVowel ()
    {
    ...
    */
    ...
    /*
    [Test]
    public void TestFlattenDipthongs ()
    {
    ...
    */
    ...
    public void Test10AnalyzeReadability ()
    {
      ...
      foreach( string SampleText in SampleTexts )
      {
        ...
        //Assert.GreaterOrEqual( Grade, 1, "Unexpected Grade" );

        //Assert.LessOrEqual( Grade, 21, "Unexpected Grade" );
